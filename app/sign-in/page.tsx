                ...
                <>
                  ...
                  <Button
                    ...
                    onClick={() => {
                      ...
                      try {
                        // Store dev session flag in both localStorage and cookie
                        localStorage.setItem('dev-session', 'true');
                        
                        // Set cookie for middleware detection
                        document.cookie = 'dev-session=true; path=/; max-age=86400'; // 24 hours
                        ...
                        console.error("Error in Skip Auth handler:", error);
